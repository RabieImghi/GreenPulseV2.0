...
public class MainService {
    ...
    public static void displayMenuUser(){
        ...
        System.out.println(YELLOW + "| [3]  Delete User           [5]  Display All Users  |" + RESET);
        System.out.println(BLUE + "|====================================================|" + RESET);
        System.out.println(GREEN + "|                Consumption Management              |" + RESET);
        System.out.println(BLUE + "|====================================================|" + RESET);
        System.out.println(YELLOW + "| [4]  Add Consumption       [6]  Display Users >3000|" + RESET);
        System.out.println(YELLOW + "| [8]  Sort Users by Consumption                     |" + RESET);
        System.out.println(BLUE + "|====================================================|" + RESET);
        System.out.println(GREEN + "|                  Impact / Analytics                |" + RESET);
        System.out.println(BLUE + "|====================================================|" + RESET);
        System.out.println(YELLOW + "| [7]  Inactive User Detection [9]  Avg Consumption  |" + RESET);
